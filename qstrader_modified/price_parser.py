...
class PriceParser(object):
    ...
    within qstrader_modified. Due to efficiency and floating point precision limitations,
    ...
    the qstrader_modified system. Numbers should also always be parsed correctly to view.
